function [G_ran,G_col,G_matr,rvec]=globalmat_Biharmonic(EN,K,val_penal,Beta2,ete,xy,elem)
...
nBloc=0;
 for ii=1:EN
    tt=elem(ii,1:3);
    xy_vex=xy(tt,1:2);  
    [Aloc,Floc]=localmat_vol_Delta(K,xy_vex);
    ...
    for jj=1:3
        ...
        loc_xy2=xy(tt,1:2);   
		[Bloc11,Bloc12,Floc]=localmat_face_Biharmonic(K,val_penal,Beta2,ii,jj,xy_vex, normal_vec,ete(ii,jj), loc_xy2);
